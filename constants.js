const features = ['ski_in_ski_out','hot_tub','childcare','pool','sauna','steam_room','wifi', 'all_ensuite',
'corporate','single_room','short_breaks','adults_only','ski_area','nearly_ski_in_ski_out','open_fire',
'all_not_ensuite','in_house_creche','private_bus','private_chauffeur','shared_driver','in_resort_driver','local_pass_inc'];
